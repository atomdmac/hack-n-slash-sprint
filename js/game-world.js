define(
['jaws', '$', 'lib/signals', 'DATABASE', 'lib/SAT', 'collider', 'entities/player', 'entities/npc', 'entities/characters/tellah', 'entities/characters/edge', 'entities/item', 'entities/zone-switcher', 'entities/patrol-point', 'entities/items/switch'],
function (jaws, $, signals, DATABASE, SAT, Collider, Player, NPC, Tellah, Edge, Item, ZoneSwitcher, PatrolPoint, Switch) {
